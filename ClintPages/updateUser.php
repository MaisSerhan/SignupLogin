...
<body>
    ...
    <center>
        <div class="main">
            <form action="../ServerPage/upUser.php" method="post" enctype="multipart/form-data">
                <h2>update user </h2>
              ...
              <!--  <input type="text" name="privileges" placeholder="privileges" value='<?php echo $data['privileges']; ?>'>-->
                ...
                <label for="photo">تحديث صورة الملف</label>
               
                <input type="file" id="file" name="uploading" style="display: none;" accept=".pdf, .docx, .xlsx">
                <label for="file">تحديث الملف </label>
                
                <br>
                <button name="update">تعديل بياناتك</button>
                <a href="../ServerPage/showUser.php">عرض ملفك</a>
            </form>
        </div>
        <p>Developer Mais</p>
    </center>
